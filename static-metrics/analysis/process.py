...
def read_coverage_matrix(file):
    ...
    covg_arr = np.intc(np.array(covg))
    return covgs 
...
def read_elements(file):
    ...
    e.g., org.apache.hadoop.hbase.regionserver$ChunkCreator#ChunkCreator(int,boolean,long,float,float,org.apache.hadoop.hbase.regionserver.HeapMemoryManager,float):89
    """
