...
public abstract class AbstractAgentMojo extends AbstractGZoltarMojo {
  ...
  /**
   * Additional classes that should be instrumented, identified by their owning package
   * each packages should be separated by ':'
   */
  @Parameter(property = "gzoltar.additionalPackages",defaultValue = "")
  ...
  protected AgentConfigs createAgentConfigurations() {
    ...
    if(this.additionalPackages != null){
      agentConfigs.setAdditionalPackages(this.additionalPackages);
    }
