...
public final class AgentConfigs {
  ...
  /**
   * Specifies the packages from which the classes should be instrumented
   */
  public static final String ADDITIONAL_PACKAGES_KEY = "additionalPackages";
  public static final String ADDITIONAL_PACKAGES_DEFAULT = "";
  ...
  private static final Collection<String> VALID_CONFIGS =
      Arrays.asList(BUILDLOCATION_KEY, DESTFILE_KEY, INCLUDES_KEY, EXCLUDES_KEY,
          ...
          INCLPUBLICMETHODS_KEY, INCLSTATICCONSTRUCTORS_KEY, INCLDEPRECATEDMETHODS_KEY, ADDITIONAL_PACKAGES_KEY);
  ...
  /**
   * Get the additional packages that should be instrumented
   * @return the package containing the classes to be instrumented
   */
  public String getAdditionalPackages() {
    return this.getConfig(ADDITIONAL_PACKAGES_KEY,ADDITIONAL_PACKAGES_DEFAULT);
  }

  /**
   * Set the additional packages containing the classes to be instrumented
   * @param packages the additional packages
   */
  public void setAdditionalPackages(final String packages) {
    this.setConfig(ADDITIONAL_PACKAGES_KEY, packages);
  }
